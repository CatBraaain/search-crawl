...
class CrawlRequestWithUrls(BaseModel):
    """
    ...
    urls: List[StrictStr]
    __properties: ClassVar[List[str]] = ["crawl_config", "cache_config", "urls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CrawlRequestWithUrls from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CrawlRequestWithUrls from a dict"""
        if obj is None:
            return None
